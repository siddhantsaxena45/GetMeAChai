  ...
  return (
    <>
      ...
      {/* <div className='flex justify-center items-center gap-4 m-10'>
        <div className='w-1/2 bg-gray-800 p-10 rounded-3xl h-[50vh] '>
          <h3 className='text-4xl font-bold mb-3'>Supporters</h3>
          <ul className='overflow-y-scroll scrollbar-thin h-[80%]'>
            <li className='mt-2'>
              <div className='flex bg-gray-700 p-3 rounded-lg gap-2'>
        ...
        <div className='w-1/2 bg-gray-800  p-10 rounded-3xl h-[50vh]'>
          ...
          <div className='flex items-center gap-4 my-3 '>
            <button type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">Pay $1</button><button type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">Pay $5</button><button type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">Pay $10</button>
